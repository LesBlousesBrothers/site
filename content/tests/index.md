...
<div id="tabTexte">
    <div class="hidden p-4  bg-mycolor-200" id="cadre-texte" role="tabpanel" aria-labelledby="cadre-bouton">
        <p class="text-base text-mygray-700 ">A proximité des gorges de l'Aveyron, à 3 kilomètres de Saint-Antonin Noble-Val, dans un endroit calme et retiré du causse, au milieu des bois.</p>
        {{<  typo/space >}}
        <div class="hidden md:grid grid-cols-3 3 gap-4">
            <div>
        ...
        <div class="md:hidden">
        <br>
            <img class="h-auto max-w-full rounded-lg" src="https://i-mc.unimedias.fr/2023/06/23/m67_chalet_suisse_cbrerouge_fld.jpg?auto=format%2Ccompress&crop=faces&cs=tinysrgb&fit=max&w=680" alt="">
        </div>
    </div>
    <div class="hidden p-4  bg-mycolor-300"  id="chalet-texte" role="tabpanel" aria-labelledby="chalet-bouton">
        <p class="text-base text-mygray-800 ">Un châlet en bois pour deux personnes, avec une salle d'eau indépendante et des toilettes sèches</p>
        {{<  typo/space >}}
        <div class="hidden md:grid grid-cols-3 3 gap-4">
            <div>
                <img class="h-auto max-w-full rounded-lg" src="https://static.wixstatic.com/media/742a36_40d150ea70564155a62423716d50d1de~mv2.jpg/v1/fill/w_740,h_493,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/742a36_40d150ea70564155a62423716d50d1de~mv2.jpg" alt="">
            </div>
            <div>
                <img class="h-auto max-w-full rounded-lg" src="https://static.wixstatic.com/media/742a36_40d150ea70564155a62423716d50d1de~mv2.jpg/v1/fill/w_740,h_493,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/742a36_40d150ea70564155a62423716d50d1de~mv2.jpg" alt="">
            </div>
    ...
    <div class="hidden p-4  bg-mycolor-400" id="region-texte" role="tabpanel" aria-labelledby="region-bouton">
        <p class="text-base text-mygray-900 ">Une région touristique incomparable : paysages somptueux, villages de caractère, activités multiples.</p>
        {{<  typo/space >}}
        <div class="hidden md:grid grid-cols-3 3 gap-4">
            <div>
                <img class="h-auto max-w-full rounded-lg" src="https://static.wixstatic.com/media/742a36_40d150ea70564155a62423716d50d1de~mv2.jpg/v1/fill/w_740,h_493,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/742a36_40d150ea70564155a62423716d50d1de~mv2.jpg" alt="">
        ...
        <div class="md:hidden">
            <br>
            <img class="h-auto max-w-full " src="https://www.tourisme-occitanie.com/uploads/2018/9/le-marche-de-saint-antonin-noble-val_joel-damase-adt-82.jpg" alt="">
        </div>               
    </div>
</div>
...
<img class="rounded-full" src="images/recup.webp" />


<p class="text-yellow-600">Est-ce que ça marche ???</p>
